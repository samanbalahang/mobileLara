            ...
            <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        ...
                        <li><a href="{{route('media.index')}}">افزودن</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab0" type="button" href="#">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="adv-tab0" role="tab" type="button" href="">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('products.index')}}">همه محصولات</a></li>
                        <li><a href="{{route('products.create')}}">افزودن جدید</a></li>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('marketers.index')}}">مشاهده بازاریابها</a></li>
                        <li><a href="{{route('marketers.create')}}">افزودن بازاریاب</a></li>
                        <li><a href="{{route('coupons.index')}}">کپن ها</a></li>
                        <li><a href="{{route('coupons.create')}}">افزودن کپن</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        ...
                        <li><a href="{{route('users.create')}}">افزودن</a></li>
                        <!-- <li><a href="#">ابزارک ها</a></li>
